...
void prepare()
{
    cout<<"starting IN prepare()..."<<endl;
    FILE* f1 = fopen("/home/a914/zhaodi/Embedding/data/EmbeddingTrainingData 2/1990 to 2013/TrainingDataUmls/entity2id.txt","r");
	cout<<"step 1..."<<endl;
	FILE* f2 = fopen("/home/a914/zhaodi/Embedding/data/EmbeddingTrainingData 2/1990 to 2013/TrainingDataUmls/relation2id.txt","r");
	cout<<"step 2..."<<endl;
	int x;
    ...
    FILE* f_kb = fopen("/home/a914/zhaodi/Embedding/data/EmbeddingTrainingData 2/1990 to 2013/TrainingDataUmls/train.txt","r");
	cout<<"step 5..."<<endl;
